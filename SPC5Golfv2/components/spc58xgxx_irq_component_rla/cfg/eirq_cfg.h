...
#define SPC5_EIRQ_GROUP_0_IRQ_PRIORITY      INTC_PSR_ENABLE(INTC_PSR_CORE1,6)
#define SPC5_EIRQ_GROUP_1_IRQ_PRIORITY      INTC_PSR_ENABLE(INTC_PSR_CORE1,6)
...
#define SPC5_SIUL_EIRQ_GROUP_0_MAX          7U
#define SPC5_SIUL_EIRQ_GROUP_1_MIN          8U
#define SPC5_SIUL_EIRQ_GROUP_1_MAX          15U
